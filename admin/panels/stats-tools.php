	...
	<table class="ur_tools_table widefat" cellspacing="0">
		...
		<tbody class="tools">
			<tr>
				...
				<td>
					<p>
						<a href="javascript:void(0)" id="reset-post-type-stats" class="button"><?php _e('Reset content rating stats', 'elm'); ?></a> <span class="reset-post-type-stats-message"></span><input type="hidden" name="reset_post_type_stats_nonce" id="reset-post-type-stats-nonce" value="<?php echo wp_create_nonce( 'elm_rml_reset_post_type_stats_action' ); ?>" />
