...
<div class="wrap rating-manager">
    ...
    <form action="" method="post">
        <table class="form-table">
			...
			<tr>
				<th scope="row">
					<label><?php _e('Precision value', 'elm'); ?></label>
				</th>
				<td>
				<input type="number" name="precision" id="precision" class="small-text" value="<?php echo esc_html( $settings['style']['precision'] ); ?>" />

				<p class="description"><?php _e('Set the precision in which the rating value should be displayed.', 'elm'); ?></p>
                </td>
			</tr>
			<tr>
                <th scope="row">
